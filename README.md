...
#### 项目问题交流
QQ群：578859618 （micro-mall-api交流群）欢迎赞助     
![avatar](./交流群.JPG)   

#### 如何赞助
任何商业用途（包括卖课平台，二次开发商用，毕业设计等）都需要作者授权，否则视为侵权追究法律责任。   
开源项目的发展离不开大家的鼓励和赞赏，扫描下方二维码鼓励一下吧（赞助后加群注明赞助账号昵称）   
![avatar](./微信赞赏码.JPG)
...
micro | 50.00            | 2023-10-3  | 很好
三丰AA | 2000.00          | 2023-10-24 | 二开商业授权
不用iPhone | 30.00            | 2023-10-27 | 辛苦
fixer | 80.00            | 2023-11-16 | 技术指导
泰国狗哥 | 66.66            | 2023-12-9  | 666
joker | 200              | 2023-12-26 | 学习学习
...
##### 需要配置什么
基本上就是日志路径，MySQL，Redis，rabbitmq，elasticsearch，MongoDB（可选），email，seata这些，如果是基于docker构建项目则只需要配置email参数
